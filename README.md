...
This is a customised Neofetch. It fixes displaying bugs for MacOS and add theme sound support. Tests passed on MacOS High Sierra. Please click to check the DEMO video: 
